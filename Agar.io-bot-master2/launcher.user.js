...
(function(d, e) {
    ...
    function gb() {
        ...
        var displayText = 'Placar: ' + ~~(R / 100) + " <br> Tempo de jogo: " + nbSeconds + " seconds.";
    ...
    function drawStats(d) {
        ...
        var debugStrings = [];
        debugStrings.push("JunimPCSD - MITO "); //+ window.botList[botIndex][0]);
        debugStrings.push("T - Bot: " + (!toggle ? "On" : "Off"));
        debugStrings.push("R - Marcação de linha: " + (!toggleDraw ? "Ligado" : "Desligado"));
        debugStrings.push("");
        debugStrings.push("Melhor placar: " + ~~(sessionScore / 100));
        debugStrings.push("Melhor tempo: " + bestTime + " segundos");
        debugStrings.push("");
        ...
        if (getPlayer().length > 0) {
            ...
            debugStrings.push("Minha localização: " + Math.floor(getPlayer()[0].x + offsetX) + ", " + Math.floor(getPlayer()[0].y + offsetY));
        }
